...
import com.example.sample.Farm;
...
public class TinyDB {
    ...
    public ArrayList<Farm> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<Farm> playerList =  new ArrayList<Farm>();

        for(String jObjString : objStrings){
            Farm player  = gson.fromJson(jObjString,  Farm.class);
    ...
    public void putListObject(String key, ArrayList<Farm> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Farm player: playerList){
